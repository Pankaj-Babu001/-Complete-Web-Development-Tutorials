...
form.addEventListener('submit', (e) => {
    ...
    const text = `
        <div class="reading-section">
            <p class="greeting">✨ Hello, <strong>${name} ${surname}</strong>!</p>
        </div>
        
        <div class="reading-section">
            <p class="zodiac">🔮 Your Zodiac Sign: <strong>${zodiacSigns[month-1]}</strong></p>
        </div>
        
        <div class="reading-section">
            <p class="compliment">💫 <strong>Your Special Quality:</strong><br>${compliments[day-1]}</p>
        </div>
        
        <div class="reading-section">
            <p class="victim">💭 <strong>A Truth About You:</strong><br>${victimCardCompliments[year%20]}</p>
        </div>
        
        <div class="reading-section">
            <p class="recommendation">🌟 <strong>Cosmic Recommendation:</strong><br>${recommendations[(day*month)%30]}</p>
        </div>
        
        <div class="reading-section prediction-section">
            <p class="prediction">🎯 <strong>Your Destiny:</strong><br>${predictions[(name.length*surname.length)%20]}</p>
        </div>
    `;
